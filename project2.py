...
main_application.title("HEditor Pro")
main_application.wm_iconbitmap("HC.ico")
...
view.add_checkbutton(label="Tool Bar",onvalue=True,offvalue=0,variable=show_toolbar,image=Statusbar_icon,compound=tk.LEFT,command=hide_toolbar)
view.add_checkbutton(label="Status Bar",onvalue=True,offvalue=False,variable=show_statusbar,image=Toolbar_icon,compound=tk.LEFT,command=hide_statusbar)
